(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor-emoji', ["jquery","static/plugins/Simditor/js/simditor"], function (a0, b1) {
    ...
    // like Node.
    module.exports = factory(require("jquery"),require("static/plugins/Simditor/js/simditor"));
  } else {
