<?php /*a:2:{s:72:"/Applications/MAMP/htdocs/operator/application/admin/view/org/index.html";i:1583651133;s:76:"/Applications/MAMP/htdocs/operator/application/admin/view/public/layout.html";i:1582011447;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['jquery', 'layer', 'form', 'table', 'treeGrid'], function () {
        ...
        $('#add').on('click', function () {
            ...
            var index = layer.open({
                ...
                area: ['600px', '475px'],
                content: ['<?php echo url("org/add", ["pid" => 0, "parentorg" => "顶级节点"]); ?>', 'yes'],
    ...
    function edit(id) {
        var index = layer.open({
            ...
            area: ['600px', '475px'],
            content: ['<?php echo url("org/edit"); ?>?id=' + id, 'yes'],
            skin: 'layui-layer-molv',
            btn: ['保存', '取消'],
            btnAlign: 'c',
            yes: function(index, layero){
    ...
    function setStatus(id, status) {
        ...
        $.ajax({
            url: "<?php echo url('org/setStatus'); ?>",
            type: 'POST',
            dataType: 'json',
            data: {
                id : id,
