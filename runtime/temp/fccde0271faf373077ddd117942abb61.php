<?php /*a:2:{s:89:"/Applications/MAMP/htdocs/operator/application/index/view/settlement/assignworkorder.html";i:1583586011;s:82:"/Applications/MAMP/htdocs/operator/application/index/view/public/layer_layout.html";i:1582010668;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="auth-title">
    结算单号：<span class="text-fail text-bold" id="test"><?php echo htmlentities($settlementInfo['id']); ?></span>
</div>
<div class="auth-title">
    结算单位：<span class="text-fail text-bold" id="test"><?php echo htmlentities($settlementInfo['org']['name']); ?></span>
</div>
...
<script>
    layui.use(['form', 'jquery', 'ztree'], function () {
        ...
        form.on('submit(submit)',function(event, treeId, treeNode){
            ...
            $.ajax({
                url: '<?php echo url("settlement/doAssign"); ?>',
                type: 'POST',
                dataType: 'json',
                data: {
