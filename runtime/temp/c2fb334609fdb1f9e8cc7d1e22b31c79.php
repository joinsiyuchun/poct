<?php /*a:2:{s:70:"/Applications/MAMP/htdocs/operator/application/admin/view/org/add.html";i:1582781014;s:82:"/Applications/MAMP/htdocs/operator/application/admin/view/public/layer_layout.html";i:1582010668;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input input-disable" disabled value="<?php echo htmlentities($parentorg); ?>">
                <input type="hidden" name="pid" value="<?php echo htmlentities($pid); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">机构部门名：</label>
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" lay-reqText="机构部门名不能为空" placeholder="请输入机构部门名" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
