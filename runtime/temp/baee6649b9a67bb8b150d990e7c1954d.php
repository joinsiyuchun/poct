<?php /*a:2:{s:74:"/Applications/MAMP/htdocs/operator/application/admin/view/admin/index.html";i:1581839295;s:76:"/Applications/MAMP/htdocs/operator/application/admin/view/public/layout.html";i:1582011447;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        $('#add').on('click', function () {
            var index = layer.open({
                type: 2,
                title: '<i class=iconfont>&#xe7c7;</i> 添加管理员',
                area: ['500px', '420px'],
