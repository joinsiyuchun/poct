<?php /*a:1:{s:74:"/Applications/MAMP/htdocs/operator/application/index/view/login/index.html";i:1582339634;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="login-wrap">
            ...
            <form id="form1" method="post" class="layui-form">
                <div class="layui-form-item">
                    ...
                    <input type="text" class="layui-input" name="username" lay-verify="required" lay-reqText="用户名不能为空" value="wangwu">
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><i class="layui-icon layui-icon-password"></i></label>
                    <input type="text" class="layui-input" name="password" lay-verify="required" lay-reqText="密码不能为空" value="123456">
                </div>
                <div class="layui-form-item">
            ...
            <p class="copyright">Powered by <a href="https://www.yck12.com">一键修</a></p>
        </div>
    </div>
