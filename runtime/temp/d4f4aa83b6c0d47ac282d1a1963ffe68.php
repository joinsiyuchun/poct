<?php /*a:2:{s:78:"/Applications/MAMP/htdocs/operator/application/index/view/settlement/auth.html";i:1582357873;s:82:"/Applications/MAMP/htdocs/operator/application/index/view/public/layer_layout.html";i:1582010668;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="auth-title">
    当前维修组：<span class="text-fail text-bold" id="test"><?php echo htmlentities($catagoryInfo['name']); ?></span>
</div>
...
<script>
    layui.use(['form', 'jquery', 'ztree'], function () {
        ...
        form.on('submit(submit)',function(event, treeId, treeNode){
            ...
            $.ajax({
                url: '<?php echo url("catagory/doAuth"); ?>',
                type: 'POST',
                dataType: 'json',
                data: {
